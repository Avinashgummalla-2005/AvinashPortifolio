    ...
    <section id="resume" className="py-24 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="w-full h-[650px] rounded-2xl overflow-hidden bg-white/5 border border-white/10 relative">
            <object
              data={portfolioData.personal.resumePdf}
              type="application/pdf"
              className="w-full h-full"
            >
              <div className="flex flex-col items-center justify-center h-full p-8 text-center bg-[#0B0F19]">
                <FileText className="w-16 h-16 text-purple-400 mb-4 animate-bounce" />
                <h4 className="text-xl font-bold text-white mb-2">Resume Preview Ready</h4>
                ...
                <a
                  href={portfolioData.personal.resumePdf}
                  download="AvinashGummalla_Resume.pdf"
                  className="px-6 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-cyan-500 text-white font-semibold text-sm shadow-lg"
                >
                  Download AvinashGummalla_Resume.pdf
                </a>
              </div>
