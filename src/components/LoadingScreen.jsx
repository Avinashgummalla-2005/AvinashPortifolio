      ...
      <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="relative w-56 h-56 flex items-center justify-center mb-6">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <motion.span
                  className="text-5xl sm:text-6xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-[#FFF5C0] via-[#D4AF37] to-[#AA7C11] font-mono drop-shadow-[0_2px_10px_rgba(212,175,55,0.3)]"
                >
                  {progress}%
                </motion.span>
                
                <span className="text-[10px] uppercase font-mono tracking-[0.3em] text-amber-200/60 mt-1">
                  Loading Experience
                </span>
              </div>
        ...
        {step === 2 && (
          <motion.div
            ...
            className="relative z-10 flex flex-col items-center justify-center p-6 text-center space-y-4"
          >
            {/* Handwritten "hello" */}
            <motion.h1
              ...
              className="text-7xl sm:text-9xl font-normal text-transparent bg-clip-text bg-gradient-to-b from-[#FFF8D6] via-[#E6CA65] to-[#B8860B] drop-shadow-[0_4px_20px_rgba(212,175,55,0.4)] tracking-wide"
            >
              hello
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg sm:text-2xl font-medium tracking-[0.25em] uppercase text-transparent bg-clip-text bg-gradient-to-r from-[#F5E6AD] via-[#D4AF37] to-[#F5E6AD] drop-shadow-[0_2px_12px_rgba(212,175,55,0.3)]"
            >
              Welcome to Avi's world
            </motion.p>
          </motion.div>
