      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="lg:col-span-7 bg-[#0e0e1a] rounded-2xl p-6 sm:p-8 border border-white/10 shadow-xl space-y-4"
          >
          ...
          >
            {stats.map((stat, idx) => (
              <div
                key={idx}
                className="bg-[#0e0e1a] rounded-2xl p-5 border border-white/10 hover:border-cyan-500/40 transition-all flex flex-col justify-between shadow-lg hover:-translate-y-1"
              >
                <span className="text-[11px] font-mono uppercase text-gray-400 tracking-wider">
                  {stat.label}
                </span>
                <div className="mt-3">
                  <span className="text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-300 font-mono">
            ...
            <div className="col-span-2 bg-gradient-to-br from-purple-950/40 to-cyan-950/40 rounded-2xl p-5 border border-cyan-500/30 flex items-center justify-between">
              ...
              <a
                ...
                className="px-3.5 py-1.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black text-xs font-bold transition-all"
              >
                View Resume
              </a>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {experience.map((exp, idx) => (
              <motion.div
                ...
                className="bg-[#0e0e1a] rounded-2xl p-6 border border-white/10 hover:border-cyan-500/40 transition-all flex flex-col justify-between shadow-xl"
              >
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <span className="text-[11px] text-gray-500 font-mono block mt-0.5">{exp.location}</span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {education.map((edu, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: idx * 0.1 }}
                className="bg-[#0e0e1a] rounded-2xl p-6 border border-white/10 hover:border-purple-500/40 transition-all flex flex-col justify-between shadow-xl"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                ...
                <div className="pt-3 mt-3 border-t border-white/5 text-[11px] text-gray-500 font-mono">
                  {edu.location}
                </div>
              </motion.div>
            ))}
