...
export default function CurrentlyExploring() {
  ...
  return (
    <section id="currently-exploring" className="py-20 bg-[#080812] text-gray-100 relative overflow-hidden border-t border-white/5">
      {/* Subtle Glow */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-sm max-w-md mt-2 md:mt-0 font-light">
          ...
          {currentlyExploring.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="rounded-2xl p-6 bg-[#0e0e1c] border border-white/10 hover:border-cyan-500/40 transition-all duration-300 relative group flex flex-col justify-between"
              >
                <div>
