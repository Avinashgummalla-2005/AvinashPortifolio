...
export default function Projects({ activeTechFilter, onClearTechFilter }) {
  ...
  return (
    <section id="projects" className="py-24 relative bg-[#050509] text-gray-100 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {activeTechFilter && activeTechObj && (
          <motion.div 
            ...
            className="mb-8 p-4 rounded-2xl bg-cyan-950/40 border border-cyan-500/40 flex items-center justify-between max-w-xl mx-auto"
          >
          ...
          {filteredProjects.map((project, idx) => (
            ...
            >
              <div className="relative aspect-[16/9] bg-black/60 overflow-hidden">
                ...
                <span className="absolute top-4 left-4 px-3 py-1 rounded-full text-[11px] font-bold bg-black/70 backdrop-blur-md text-cyan-300 border border-white/10 font-mono">
                  {project.category}
                </span>
              </div>
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <p className="text-xs text-purple-400 font-mono mt-0.5 mb-2">
                    {project.subtitle}
                  </p>
                ...
                <div className="flex flex-wrap gap-1.5 pt-2">
                  {project.tags.map((tag, tIdx) => (
                    <span 
                      key={tIdx} 
                      className="text-[10px] px-2.5 py-1 rounded-md bg-white/5 text-gray-300 font-mono border border-white/5"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-semibold text-gray-200 hover:text-cyan-300 transition-colors"
                  >
