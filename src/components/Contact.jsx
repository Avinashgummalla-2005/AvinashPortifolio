...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 relative bg-[#050509] text-gray-100 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          >
            <div className="bg-[#0e0e1a] rounded-3xl p-8 border border-white/10 shadow-xl space-y-6">
              <h3 className="text-xl font-bold text-white mb-2">Contact Details</h3>

              <a
                href={`mailto:${personal.email}`}
                className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 hover:border-cyan-500/40 transition-all group"
              >
                <div className="p-3 rounded-xl bg-purple-950 text-cyan-400 group-hover:scale-110 transition-transform">
                  <MailIcon className="w-5 h-5" />
                </div>
                <div>
                  <span className="text-[11px] font-mono text-gray-500 block">EMAIL ADDRESS</span>
                  <span className="text-xs sm:text-sm font-semibold text-gray-200 group-hover:text-cyan-300 transition-colors">
                    {personal.email}
                  </span>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <span className="text-[11px] font-mono text-gray-500 block">LINKEDIN PROFILE</span>
                  <span className="text-xs sm:text-sm font-semibold text-gray-200 group-hover:text-cyan-300 transition-colors">
                    in/avinash-gummalla
                  </span>
                </div>
              ...
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 hover:border-cyan-500/40 transition-all group"
              >
                <div className="p-3 rounded-xl bg-gray-900 text-gray-300 group-hover:scale-110 transition-transform">
                  <GithubIcon className="w-5 h-5" />
                </div>
                <div>
                  <span className="text-[11px] font-mono text-gray-500 block">GITHUB REPOSITORIES</span>
                  <span className="text-xs sm:text-sm font-semibold text-gray-200 group-hover:text-cyan-300 transition-colors">
          ...
          <motion.div
            ...
            className="lg:col-span-7 bg-[#0e0e1a] rounded-3xl p-8 border border-white/10 shadow-xl"
          >
