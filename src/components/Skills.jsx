...
export default function Skills() {
  ...
  return (
    <section id="skills" className="py-14 sm:py-24 relative bg-[#050509] text-gray-100 overflow-hidden">
          ...
          {skills.map((skill, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#0b0b16] rounded-2xl p-4 sm:p-5 border border-white/10 hover:border-cyan-500/40 transition-all duration-300 shadow-lg flex flex-col justify-between group"
              >
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-[9px] sm:text-[10px] font-mono text-purple-400 px-2 py-0.5 rounded bg-purple-950/60 border border-purple-500/20">
                      {skill.category}
                    </span>
                  </div>
                  ...
                  <p className="text-xs text-gray-400 mt-1.5 sm:mt-2 leading-relaxed font-light">
                    {skill.description}
                  </p>
                </div>
              </motion.div>
