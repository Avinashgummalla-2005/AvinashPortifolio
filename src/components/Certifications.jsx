...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="py-24 relative bg-[#070712] text-gray-100 overflow-hidden border-t border-white/5">
      {/* Background Lighting */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-950/60 border border-cyan-500/30 text-cyan-400 text-xs font-mono mb-3">
          ...
          <p className="mt-3 text-gray-400 max-w-xl mx-auto text-sm md:text-base">
            Formal technical certifications, specialized institute training, and industry course completions.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {certifications.map((cert, idx) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="bg-[#0e0e1c] rounded-2xl p-6 border border-white/10 hover:border-cyan-500/40 transition-all duration-300 shadow-xl flex flex-col justify-between group"
            >
              <div className="space-y-4">
                {/* Provider & Badge */}
                <div className="flex items-center justify-between">
                  <span className="px-3 py-1 rounded-full text-[11px] font-semibold bg-purple-950/70 text-purple-300 border border-purple-500/30 font-mono">
                    {cert.badge}
                  </span>
              ...
              <div className="pt-5 mt-4 border-t border-white/5 flex items-center justify-between">
                <span className="text-[11px] font-mono text-gray-500">{cert.skillCategory}</span>
                <button
      ...
      <AnimatePresence>
        {selectedCert && (
          ...
          >
            <div 
              className="relative max-w-xl w-full bg-[#0d0d1a] border border-cyan-500/30 rounded-3xl p-6 sm:p-8 shadow-2xl text-left space-y-5"
            ...
            >
              ...
              {/* Preview Image */}
              <div className="aspect-[16/9] rounded-xl bg-black/60 border border-white/10 overflow-hidden">
                <img 
              ...
              <div className="pt-4 border-t border-white/10 flex items-center justify-between text-xs font-mono text-gray-400">
                <span>Verification: Placeholder Link</span>
                <button
                  onClick={() => setSelectedCert(null)}
