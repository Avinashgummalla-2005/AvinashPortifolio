    ...
    <section id="certifications" className="py-24 relative bg-[#070712] text-gray-100 overflow-hidden border-t border-white/5">
      ...
      <AnimatePresence>
        {selectedCert && (
          ...
          >
            <div 
              className="relative max-w-xl w-full max-h-[90vh] overflow-y-auto bg-[#0d0d1a] border border-cyan-500/30 rounded-3xl p-6 sm:p-8 shadow-2xl text-left space-y-5"
